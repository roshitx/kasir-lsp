                    ...
                    <form action="{{ route('products.store') }}" method="post" enctype="multipart/form-data" class="mt-6 space-y-6">
                        ...
                        <div class="max-w-xl">
                            <div class="form-control">
                                ...
                                <x-text-input id="price" name="price" type="number" class="mt-1 block w-full" :value="old('price')" required autofocus />
                        ...
                        <div class="max-w-xl">
                            <div class="form-control">
                                ...
                                <x-text-input id="stock" name="stock" type="number" class="mt-1 block w-full" :value="old('stock')" required autofocus />
